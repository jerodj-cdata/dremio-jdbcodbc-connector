...
@SourceType(value = "JDBCODBCARP", label = "JDBCODBC",uiConfig = "jdbcodbc-layout.json")
public class JDBCODBCConf extends AbstractArpConf<JDBCODBCConf> {
  private static final String ARP_FILENAME = "arp/implementation/jdbcodbc-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.jdbcodbc.JDBCODBCDriver";
